...
const WorkoutActions = ({ id }: WorkoutActionsProps) => {
  ...
  return (
    <div className="flex flex-wrap gap-3 mt-6">
      <button
        ...
        className={`flex items-center gap-2 rounded-md px-5 py-2.5 text-sm font-bold transition-colors ${
          inPlan
      ...
      <button
        ...
        className={`flex items-center gap-2 rounded-md px-5 py-2.5 text-sm font-bold border transition-colors ${
          inSaved
